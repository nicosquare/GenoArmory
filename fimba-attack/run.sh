...
do
    ...
    python shap_dl_analysis2.py --data_dir /projects/p32013/DNABERT-meta/GUE/${task}/fimba \
    ...
    python runatk_standalone.py --data_dir /projects/p32013/DNABERT-meta/GUE/${task}/fimba \
                    --model_name_or_path /scratch/hlv8980/Attack_Benchmark/models/${model}/${task}/origin  \
                    --task_name $task --num_label 2  --max_seq_length 128 \
                    --shap_file shap_dicts/shap_${model}_fimba_$task.pkl \
