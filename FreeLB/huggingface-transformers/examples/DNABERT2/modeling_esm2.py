...
class EsmLayer(nn.Module):
    ...
    def forward(
        ...
        self_attention_outputs, mask1 = self.attention(
            hidden_states,
            attention_mask,
            head_mask,
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                layer_outputs, dp_mask_ = layer_module(
                    hidden_states,
                    attention_mask,
                    layer_head_mask,
                    encoder_hidden_states,
...
class EsmModel(EsmPreTrainedModel):
    ...
    def forward(
        ...
        if not return_dict:
            return (sequence_output, pooled_output) + encoder_outputs[1:], dp_mask
...
class EsmForSequenceClassification(EsmPreTrainedModel):
    ...
    def forward(
        ...
        outputs, encoder_dp_masks = self.esm(
            input_ids,
            attention_mask=attention_mask,
            position_ids=position_ids,
            head_mask=head_mask,
