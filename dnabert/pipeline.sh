...
for task in "${tasks[@]}"; do
    python train.py \
        ...
        --data_path "/projects/p32013/DNABERT-meta/GUE/${task}" \
        --kmer -1 \
        --run_name "dnabert_${task}" \
        ...
        --fp16 \
        --save_steps 200 \
        --output_dir "output_pipe/${task}/origin" \
        --save_total_limit 1 \
    ...
    python train.py \
        --model_name_or_path "zhihan1996/DNABERT-2-117M" \
        --data_path "/projects/p32013/DNABERT-meta/GUE/${task}/invert" \
        --kmer -1 \
        --run_name "dnabert_${task}" \
        --model_max_length 256 \
        --per_device_train_batch_size 64 \
        ...
        --fp16 \
        --save_steps 200 \
        --output_dir "output_pipe/${task}/invert" \
        --save_total_limit 1 \
        --evaluation_strategy steps \
        --eval_steps 200 \
        --warmup_ratio 0.05 \
    ...
    python train.py \
        --model_name_or_path "zhihan1996/DNABERT-2-117M" \
        --data_path "/projects/p32013/DNABERT-meta/GUE/${task}/noninvert" \
        --kmer -1 \
        --run_name "dnabert_${task}" \
        --model_max_length 256 \
        --per_device_train_batch_size 64 \
        ...
        --fp16 \
        --save_steps 200 \
        --output_dir "output_pipe/${task}/noninvert" \
        --save_total_limit 1 \
        --evaluation_strategy steps \
        --eval_steps 200 \
        --warmup_ratio 0.05 \
