...
command_template = 'python attack_classification_general.py --dataset_path {dataset_path} ' \
                   ...
                   '--output_dir /projects/p32013/DNABERT-meta/TextFooler/output/ADFAR/{model}/{dataset_dir} ' \
                   ...
                   '--USE_cache_path /projects/p32013/DNABERT-meta/TextFooler/tf_cache ' \
                   '--nclasses 2 --tokenizer_path /scratch/hlv8980/Attack_Benchmark/models/{model}/{dataset_dir}/origin' \
