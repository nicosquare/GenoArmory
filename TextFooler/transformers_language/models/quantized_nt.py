...
class QuantizedEsmContactPredictionHead(QuantizedModel):
    ...
    def __init__(
        ...
        self.regression_act = quantize_model(
            nn.Sequential(org_module.regression, org_module.activation), **quant_params
        )
    ...
    def forward(self, tokens, attentions):
        ...
        return self.regression_act(attentions).squeeze(3)
...
class QuantizedEsmEmbeddings(QuantizedModel):
    ...
    def __init__(self, 
        ...
        **quant_params,
        ...
        self.position_ids = org_module.position_ids
...
class QuantizedEsmSelfAttentionwithExtra(QuantizedModel):
    def __init__(self, 
        org_module,
        ...
        **quant_params
        ...
        self.quant_dict = _make_quant_dict(quant_params["quant_dict"])
        super().__init__()
        self.softmax_fn = org_module.softmax_fn
...
class QuantizedEsmAttention(QuantizedModel):
    def __init__(self, org_module, **quant_params):
        ...
        self.self = QuantizedEsmSelfAttentionwithExtra(org_module.self, **quant_params)
...
class QuantizedEsmPooler(QuantizedModel):
    def __init__(self, org_module, **quant_params):
        ...
        self.dense_act = quantize_model(
            nn.Sequential(org_module.dense, org_module.activation), **quant_params
        )
...
class QuantizedEsmForSequenceClassification(QuantizedModel):
    def __init__(self, org_module, **quant_params):
        ...
        self.classifier = org_module.classifier
