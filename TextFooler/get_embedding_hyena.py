...
model_type = 'hyena'
mlm_path = 'LongSafari/hyenadna-small-32k-seqlen-hf'
# config_tgt = AutoConfig.from_pretrained(mlm_path)
mlm_model = AutoModelForSequenceClassification.from_pretrained(mlm_path, trust_remote_code=True)
mlm_model.to('cuda')
...
embedding_layer = mlm_model.get_input_embeddings()
