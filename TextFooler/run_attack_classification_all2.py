...
command_template = 'python attack_classification_general.py --dataset_path {dataset_path} ' \
                   ...
                   '--output_dir /projects/p32013/DNABERT-meta/TextFooler/output/All/{model}/{dataset_dir} ' \
...
for dataset_dir in dataset_dirs:
    ...
    target_model_path = f"/scratch/hlv8980/Attack_Benchmark/models/{model}/{dataset_dir}/all"
