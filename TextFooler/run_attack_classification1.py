...
command_template = 'python attack_classification_general.py --dataset_path {dataset_path} ' \
                   ...
                   '--output_dir /projects/p32013/DNABERT-meta/TextFooler/output/FreeLB/{model}/{dataset_dir} ' \
...
#                 "tf3", "tf4", "0", "1", "2", "3", "4"]
dataset_dirs = ["tf4", "0", "1", "2", "3", "4"]
# dataset_dirs = ["0"]

# Loop over each dataset directory
for dataset_dir in dataset_dirs:
    dataset_path = os.path.join(base_dir, dataset_dir, 'five_percent/cat.csv')
    target_model_path = f"/scratch/hlv8980/Attack_Benchmark/models/FreeLB/{model}/{model}_{dataset_dir}"
