...
cat /projects/p32013/DNABERT-meta/BERT-Attack/scripts/nt1_quant/emp2.txt | python batch_run.py --gpus 0,0
cat /projects/p32013/DNABERT-meta/BERT-Attack/scripts/nt1_quant/mouse2.txt | python batch_run.py --gpus 0
