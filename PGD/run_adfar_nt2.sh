...
tasks=("H3K36me3" "H3K4me1" "H3K4me2" "H3K4me3" "H3K79me3" "H3K9ac" "H4" "H4ac" "prom_core_all" "prom_core_notata" "prom_core_tata" "prom_300_all" "prom_300_notata" "prom_300_tata" "tf0" "tf1" "tf2" "tf3" "tf4" "0" "1" "2" "3" "4")

model='nt2'

for task in "${tasks[@]}"; do
    python test.py --data_dir /projects/p32013/DNABERT-meta/GUE/${task}/five_percent \
                --model_name_or_path /scratch/hlv8980/Attack_Benchmark/models/ADFAR/GUE/GUE/${model}/${task}/4times_adv_double_0-7 \
