...
tasks=( "tf0" "tf1" "tf2" "tf3" "tf4" "0" "1" "2" "3" "4")
model='og'

for task in "${tasks[@]}"; do
    python test.py --data_dir /projects/p32013/DNABERT-meta/GUE/${task} \
                --model_name_or_path /scratch/hlv8980/Attack_Benchmark/models/FreeLB/${model}/${model}_${task} \
                --task_name 0 --num_label 2 --n_gpu 1 \
                --max_seq_length 256 --batch_size 16 \
                --output_dir /projects/p32013/DNABERT-meta/PGD/results/FreeLB/${model}/${task} \
                --model_type og --overwrite_cache
