...
# python GenoArmory.py --model_path magicslabnu/GERM attack --method bertattack --params_file /projects/p32013/DNABERT-meta/scripts/BertAttack/textfooler_dnabert.json


## Defense
#python GenoArmory.py --model_path magicslabnu/GERM defense --method freelb --params_file 
