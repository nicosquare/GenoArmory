...
class Simplifier:
    ...
    def __init__(self, cos_sim_file='cos_sim_counter_fitting/cos_sim_counter_fitting.npy',
                 counterfitted_vectors='embeddings/subword_dnabert2_embeddings.txt',
        ...
        idx2word = {}
        word2idx = {}
        with open('embeddings/subword_dnabert2_embeddings.txt', 'r') as ifile:
            for line in ifile:
                word = line.split()[0]
